<div class="modal fade" id="updateLivretModal_{{$livret->id}}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="establishment_type" name="establishment_type" required>
                                ...
                                <option value="chambre_hotes" @if($livret->establishment_type == 'chambre_hotes') selected @endif>
                                    Une
                                    chambre d'hôtes
                                </option>
                                <option value="b&b" @if($livret->establishment_type == 'b&b') selected @endif>Une conciergerie B&B
                                </option>
                                <option value="location" @if($livret->establishment_type == 'location') selected @endif>Un
                                    gestionnaire
                                    de location
                                </option>
